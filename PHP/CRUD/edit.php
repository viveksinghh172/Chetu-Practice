                        ...
                        if(mysqli_num_rows($query_run) > 0)
                        {
                            ...
                            <form action="code.php" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="phone" value="<?= $data['phone']; ?>" class="form-control" placeholder="Mobile Number">
                                </div>
                                <div class="mb-3">
                                    <label for="course">Course:</label>
                                    <input type="text" name="course" value="<?= $data['course']; ?>" class="form-control" placeholder="Enter Course">
                                </div>
                                <div class="mb-3">
